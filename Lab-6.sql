...
SELECT LOWER('Rudrarajsinh'),UPPER('Rudrarajsinh');

--3 Display first three characters of your name.
SELECT SUBSTRING('Rudrarajsinh',0,4);

--4 Display 3rd to 10th character of your name.
SELECT SUBSTRING('Rudrarajsinh',3,8);
...
SELECT SPACE(10)+'Rudrarajsinh';

--14 Combine two strings using + sign as well as CONCAT ().
SELECT 'Rudrarajsinh'+'Jadeja';

SELECT CONCAT('Rudrarajsinh','Jadeja');

--15 Find reverse of “Darshan”.
SELECT REVERSE('Darshan');

--16 Repeat your name 3 times
SELECT REPLICATE('Rudrarajsinh',3);
