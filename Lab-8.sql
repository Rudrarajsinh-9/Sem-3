...
----------PART-B (GROUP BY & ORDER BY)----------


--1. Display Count of Orders by Year and Region, Sorted by Year and Region
SELECT REGION,YEAR,COUNT(PRODUCT) FROM SALES_DATA
GROUP BY YEAR,REGION
ORDER BY YEAR,REGION

--2. Display Regions with Maximum Sales Amount Exceeding 1000 in Any Year, Sorted by Region
SELECT REGION,MAX(SALES_AMOUNT) AS MAX_SALE FROM SALES_DATA
GROUP BY REGION
...
SELECT  TOP 3 REGION,SUM(SALES_AMOUNT) AS TOTALSALE FROM SALES_DATA
WHERE YEAR=2024
GROUP BY REGION 


----------PART-C (GROUP BY & ORDER BY)----------


--1. Display Products with Average Sales Amount Between 1000 and 2000, Ordered by Product Name
SELECT PRODUCT,AVG(SALES_AMOUNT) AS AVGSALE FROM SALES_DATA
GROUP BY PRODUCT
...
SELECT REGION,PRODUCT,COUNT(PRODUCT) AS DUPLICATE FROM SALES_DATA
GROUP BY REGION,PRODUCT
HAVING COUNT(PRODUCT)>1

--5. Find out region wise highest sales amount.
SELECT REGION,MAX(SALES_AMOUNT) AS HIGHEST_SALE FROM SALES_DATA
GROUP BY REGION
