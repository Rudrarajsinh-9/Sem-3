...
SELECT TOP 2 * INTO T20 FROM CRICKET
...
SELECT TOP 2 * INTO EMPLOYEE_DATA FROM EMPLOYEE WHERE 1=2
...
UPDATE DEPOSIT SET ADATE='1995-04-1' WHERE CNAME='ANIL'
--9. Update the amount of MINU to 10000. (Use Deposit Table)
UPDATE DEPOSIT SET AMOUNT=10000 
--10. Update deposit amount of PRAMOD to 5000 and ADATE to 1-4-96 (Use Deposit Table)
UPDATE DEPOSIT SET ADATE='1996-04-1', AMOUNT=5000 WHERE CNAME='PRAMOD'
...
UPDATE DEPOSIT SET ADATE='2021-01-04' WHERE AMOUNT<2000
